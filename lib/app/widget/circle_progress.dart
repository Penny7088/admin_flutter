...
class _CircleIndicatorState extends State<CircleProgress>
  ...
  @override
  void didUpdateWidget(covariant CircleProgress oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    var paintColor = widget.color??NormalColorS.colffffff;
    return Transform(
